...
defineTypeNameAndDebug(RStress, 0);
addToRunTimeSelectionTable(RASModel, RStress, dictionary);

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void RStress::correctNut()
{
