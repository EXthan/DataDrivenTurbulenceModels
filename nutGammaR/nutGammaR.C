...
defineTypeNameAndDebug(nutGammaR, 0);
addToRunTimeSelectionTable(RASModel, nutGammaR, dictionary);

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void nutGammaR::correctNut()
{
}
...
void nutGammaR::boundNormalStress
(
